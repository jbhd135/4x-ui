...
func (x *XrayAPI) handlerClient() (command.HandlerServiceClient, error) {
	if x == nil || x.HandlerServiceClient == nil {
		return nil, common.NewError("xray HandlerServiceClient is not initialized")
	}
	return *x.HandlerServiceClient, nil
}
