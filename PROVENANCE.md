...
- `v4.0.3` limits manual daily allowance choices to 10 GB, 20 GB, 30 GB and
  unlimited. Normal panel startup migrates existing 5 GB and 15 GB values
  upward to 10 GB and 20 GB before serving traffic.
